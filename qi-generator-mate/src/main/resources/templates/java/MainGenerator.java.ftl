...
//        args = new String[]{"list"};
    ...
    public void doGenerate(DateMeta dateMate) throws IOException, TemplateException {
        ...
        // 指定模板文件所在的路径
        configuration.setDirectoryForTemplateLoading(new File("${fileConfig.inputRootPath}"+File.separator + "src" + File.separator + "com" + File.separator + "xiaozhang" + File.separator + "acm"));
        // 设置模板文件使用的字符集
